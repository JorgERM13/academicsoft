                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ url('cursos/actualizar/' . $curso->id) }}" method="POST"
                                ...
                                <div class="text-center">
                                    <img src="{{ $curso->getImagenUrl() }}" alt="" height="70px">
                                </div>
                                <div class="form-group">
                                    <label for="costo">Costo</label>
                                    <input type="text" name="costo" value="{{ $curso->costo }}" class="form-control">
                                    @error('costo')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="descripcion" cols="30" rows="2">{{ $curso->descripcion }}</textarea>
                                </div>
                                @error('descripcion')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
